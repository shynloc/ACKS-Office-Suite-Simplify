...
class TestFontStyle:
    ...
    def test_create_default(self):
        from office_suite.design_system.tokens import FontStyle
        s = FontStyle()
    ...
    def test_presets_exist(self):
        from office_suite.design_system.tokens import STYLE_HEADING, STYLE_BODY, STYLE_META
...
class TestDocxGeneration:
    ...
    def test_build_document(self):
        from office_suite.design_system.tokens import build_document
        doc = build_document()
        assert len(doc.paragraphs) > 0

    def test_save_demo(self, tmp_path):
        from office_suite.design_system.tokens import save_demo
...
class TestPptxGeneration:
    ...
    def test_build_presentation(self):
        from office_suite.design_system.slides import build_presentation
        prs = build_presentation()
        assert len(prs.slides) == 11

    def test_save_demo(self, tmp_path):
        from office_suite.design_system.slides import save_demo
...
class TestFitHelpers:
    ...
    def test_fit_title_size_shrinks_long_text(self):
        from office_suite.design_system.slides import fit_title_size
    ...
    def test_fit_paragraph_size_respects_min(self):
        from office_suite.design_system.slides import fit_paragraph_size
...
class TestPptxNewComponents:
    ...
    def test_add_list_slide(self):
        from office_suite.design_system.slides import init_presentation, add_list_slide
    ...
    def test_add_checklist_slide(self):
        from office_suite.design_system.slides import init_presentation, add_checklist_slide
        prs = init_presentation()
    ...
    def test_add_template_slide(self):
        from office_suite.design_system.slides import init_presentation, add_template_slide
        prs = init_presentation()
...
class TestDocxNewComponents:
    ...
    def test_add_bullet_list(self):
        from office_suite.design_system.tokens import build_document, add_bullet_list
        doc = build_document()
    ...
    def test_add_numbered_list(self):
        from office_suite.design_system.tokens import build_document, add_numbered_list
        doc = build_document()
        n_before = len(doc.paragraphs)
    ...
    def test_add_checklist(self):
        from office_suite.design_system.tokens import build_document, add_checklist
        doc = build_document()
        n_before = len(doc.paragraphs)
    ...
    def test_add_code_block(self):
        from office_suite.design_system.tokens import build_document, add_code_block
        doc = build_document()
        n_before = len(doc.paragraphs)
...
class TestSlideGeometry:
    ...
    def test_no_shape_out_of_bounds_or_footer_overflow(self):
        ...
        from office_suite.design_system.slides import build_presentation, FOOTER_SAFE_TOP
...
class TestXlsxGeneration:
    ...
    def test_build_workbook(self):
        from office_suite.design_system.xlsx import build_workbook
        wb = build_workbook()
    ...
    def test_save_demo(self, tmp_path):
        from office_suite.design_system.xlsx import save_demo
